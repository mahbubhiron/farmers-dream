...
public class HoludAdapter extends RecyclerView.Adapter<HoludAdapter.MyViewHolder> {
    ...
    public HoludAdapter(Context context, int[] images, String[] title, String[] description) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), HoluderRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","holuder_thrips_poka");
                ...
                if(position == 1){
                    ...
                    Intent intent = new Intent(view.getContext(), HoluderRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","holuder_patar_dagrog");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
