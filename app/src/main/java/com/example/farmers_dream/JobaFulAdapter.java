...
public class JobaFulAdapter extends RecyclerView.Adapter<JobaFulAdapter.MyViewHolder> {
    ...
    public JobaFulAdapter(Context context, int[] images, String[] title, String[] description) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), JobaFulerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jobar_milibag");
                ...
                if(position == 1){
                    ...
                    Intent intent = new Intent(view.getContext(), JobaFulerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jobar_patamorano_poka");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
                ...
                if(position == 2){
                    ...
                    Intent intent = new Intent(view.getContext(), JobaFulerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jobar_jab_poka");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
