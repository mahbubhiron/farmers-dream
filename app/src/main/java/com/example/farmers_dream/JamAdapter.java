...
public class JamAdapter extends RecyclerView.Adapter<JamAdapter.MyViewHolder> {
    ...
    public JamAdapter(Context context, int[] images, String[] title, String[] description) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), JamerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jamer_patar_uilive");
                ...
                if(position == 1){
                    ...
                    Intent intent = new Intent(view.getContext(), JamerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jamer_pathar_dag_rog");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
                ...
                if(position == 2){
                    ...
                    Intent intent = new Intent(view.getContext(), JamerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jamer_lal_moricha_rog");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
                ...
                if(position == 3){
                    ...
                    Intent intent = new Intent(view.getContext(), JamerRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","jamer_pata_morano_rog");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
