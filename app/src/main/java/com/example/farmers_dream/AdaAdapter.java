...
public class AdaAdapter extends RecyclerView.Adapter<AdaAdapter.MyViewHolder> {
    ...
    public AdaAdapter(Context context, int[] images, String[] title, String[] description) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), AdarRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","adar_gach_cidrokari_poka");
                ...
                if(position == 1){
                    ...
                    Intent intent = new Intent(view.getContext(), AdarRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","adar_kondon_poca_rog");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
                ...
                if(position == 2){
                    ...
                    Intent intent = new Intent(view.getContext(), AdarRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","adar_kondon_cdrokari_poka");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
