...
public class KalojiraAdapter extends RecyclerView.Adapter<KalojiraAdapter.MyViewHolder> {
    ...
    public KalojiraAdapter(Context context, int[] images, String[] title, String[] description) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(position == 0){
                    ...
                    Intent intent = new Intent(view.getContext(), KalojirarRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","kolojirar_kando_poca_rog");
                ...
                if(position == 1){
                    ...
                    Intent intent = new Intent(view.getContext(), KalojirarRogBalaiDescriptionActivity.class);
                    intent.putExtra("key","kalojirar_fol_cidrokari_poka");
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    view.getContext().startActivity(intent);
